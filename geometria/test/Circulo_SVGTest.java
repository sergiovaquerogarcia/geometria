...
public class Circulo_SVGTest {
	
	private Circulo_SVG circulo1, circulo2, circulo3;

	@Before
	public void inicioPruebas() { //Creamos los objetos
		circulo1 = new Circulo_SVG(7, "circulo");
		circulo2 = new Circulo_SVG(0, "circulo");
		circulo3 = new Circulo_SVG(-3, "circulo");
	}
